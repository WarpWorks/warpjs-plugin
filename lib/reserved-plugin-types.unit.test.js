...
describe("lib/reserved-plugin-types", () => {
    ...
    it("should expose PORTAL_ACTION as string", () => {
        expect(moduleToTest).to.have.property('PORTAL_ACTION');
        expect(moduleToTest.PORTAL_ACTION).to.be.a('string');
        delete clone.PORTAL_ACTION;
    });
